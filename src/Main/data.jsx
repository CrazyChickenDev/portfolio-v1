export const dataExperience = {
    ...
    info: {
        ...
        2: {
            ...
            first: 'My work in Antolin corresponds to an intership needed to finish my degree in mechanical engineer.',
            second: 'My role in the company was of a product engineer intern responsible of the output of the product from the manufacturing ',
            third: 'Handling the different changes of the product through the manufactoring process with the different countries where the different parts of the product came from.',
        },
        3: {
